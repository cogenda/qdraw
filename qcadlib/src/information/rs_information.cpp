 ...
 * @return One or two intersection points between given entities.
 */
RS_VectorSolutions RS_Information::getIntersectionLineEllipse(RS_Line* line, RS_Ellipse* ellipse)
{
    ...
    RS_EntityContainer* contour, bool* onContour)
{
  ...
  do
  {
    ...
    for (RS_Entity* e = contour->firstEntity(RS2::ResolveAll); e!=NULL; e = contour->nextEntity(RS2::ResolveAll))
    {
