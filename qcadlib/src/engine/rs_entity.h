...
public:
  ...
  /**
   * Gives this entity a default label, can be override later.
   */
   ...
   */
  const RS_String & getLabel() const
  {
    return label;
  }

  /**
   * @return writable reference of label of this entity.
   */
  RS_String & getLabel()
  {
    return label;
   ...
   * set entity label
   */
  void setLabel(const RS_String & str)
  { label = str; }
