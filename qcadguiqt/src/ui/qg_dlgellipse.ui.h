...
void QG_DlgEllipse::setEllipse(RS_Ellipse& e) {
    ...
    // get ellipse division
    s.setNum(ellipse->getDivision());
    EllipseDivisionEdit->setText(s);

    // get ellipse label
    EllipseLabelEdit->setText(ellipse->getLabel());
}
...
void QG_DlgEllipse::updateEllipse() {
    ...
    ellipse->setDivision(RS_Math::eval(EllipseDivisionEdit->text()));
    ellipse->setLabel(EllipseLabelEdit->text());
}
